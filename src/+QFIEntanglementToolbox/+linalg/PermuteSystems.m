...
rowPerm = QFIEntanglementToolbox.linalg.PermuteSystems(1:sizeX(1),permVec,dimArray(1,:),0,invPerm);
outputArg = inputArg(rowPerm,:);
if ~rowOnly
    colPerm = QFIEntanglementToolbox.linalg.PermuteSystems(1:sizeX(2),permVec,dimArray(2,:),0,invPerm);
